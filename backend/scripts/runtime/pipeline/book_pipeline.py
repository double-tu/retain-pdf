...
def run_book_pipeline(
    *,
    ...
    translation_summary = translate_book_pipeline(
        ...
        auto_glossary_candidates=auto_glossary_candidates,
        auto_glossary_terms=auto_glossary_terms,
        plain_text_timeout_seconds=plain_text_timeout_seconds,
        batch_plain_text_timeout_seconds=batch_plain_text_timeout_seconds,
        formula_segment_timeout_seconds=formula_segment_timeout_seconds,
        formula_window_timeout_seconds=formula_window_timeout_seconds,
