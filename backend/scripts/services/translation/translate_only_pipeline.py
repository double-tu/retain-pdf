...
def _args_from_spec(spec: TranslateStageSpec) -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        domain_context_pages=spec.params.domain_context_pages,
        domain_context_max_chars=spec.params.domain_context_max_chars,
        local_context_neighbors=spec.params.local_context_neighbors,
        local_context_chars=spec.params.local_context_chars,
        auto_glossary_enabled=spec.params.auto_glossary_enabled,
        auto_glossary_candidates=spec.params.auto_glossary_candidates,
        auto_glossary_terms=spec.params.auto_glossary_terms,
        plain_text_timeout_seconds=spec.params.plain_text_timeout_seconds,
        batch_plain_text_timeout_seconds=spec.params.batch_plain_text_timeout_seconds,
        formula_segment_timeout_seconds=spec.params.formula_segment_timeout_seconds,
        formula_window_timeout_seconds=spec.params.formula_window_timeout_seconds,
    )
