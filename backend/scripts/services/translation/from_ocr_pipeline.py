...
def _args_from_spec(spec: BookStageSpec) -> SimpleNamespace:
    ...
    return SimpleNamespace(
        ...
        domain_context_pages=spec.translation.domain_context_pages,
        domain_context_max_chars=spec.translation.domain_context_max_chars,
        local_context_neighbors=spec.translation.local_context_neighbors,
        local_context_chars=spec.translation.local_context_chars,
        auto_glossary_enabled=spec.translation.auto_glossary_enabled,
        auto_glossary_candidates=spec.translation.auto_glossary_candidates,
        auto_glossary_terms=spec.translation.auto_glossary_terms,
        plain_text_timeout_seconds=spec.translation.plain_text_timeout_seconds,
        batch_plain_text_timeout_seconds=spec.translation.batch_plain_text_timeout_seconds,
        formula_segment_timeout_seconds=spec.translation.formula_segment_timeout_seconds,
        formula_window_timeout_seconds=spec.translation.formula_window_timeout_seconds,
...
def main() -> None:
    ...
    result = run_book_pipeline(
        ...
        domain_context_pages=args.domain_context_pages,
        domain_context_max_chars=args.domain_context_max_chars,
        local_context_neighbors=args.local_context_neighbors,
        local_context_chars=args.local_context_chars,
        auto_glossary_enabled=args.auto_glossary_enabled,
        auto_glossary_candidates=args.auto_glossary_candidates,
        auto_glossary_terms=args.auto_glossary_terms,
        plain_text_timeout_seconds=args.plain_text_timeout_seconds,
        batch_plain_text_timeout_seconds=args.batch_plain_text_timeout_seconds,
        formula_segment_timeout_seconds=args.formula_segment_timeout_seconds,
        formula_window_timeout_seconds=args.formula_window_timeout_seconds,
